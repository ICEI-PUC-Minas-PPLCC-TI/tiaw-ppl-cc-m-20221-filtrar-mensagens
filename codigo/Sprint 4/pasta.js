var pastas = [
    {
        'nome-input': 'Agenda', 'comment-input': 'Minha pasta', 'corSelecionada': 'azul', 'cor': converteCor('azul'), 'mensagens':
            [{ 'foto': 'user.jpg', 'nome': 'Bruna Neves', 'horario': '14:20', 'mensagem': 'Endereço da Luíza: Alameda Endereço, 1234, apartamento 001' },
            { 'foto': 'user.jpg', 'nome': 'Bruna Neves', 'horario': '14/06/22', 'mensagem': 'Comprar leite' },
            { 'foto': 'user.jpg', 'nome': 'Bruna Neves', 'horario': '14/06/22', 'mensagem': 'Cupon ifood: rtDf4w1' },
            { 'foto': 'user.jpg', 'nome': 'Bruna Neves', 'horario': '14/06/22', 'mensagem': 'replit.com/@user' },
            { 'foto': 'user.jpg', 'nome': 'Bruna Neves', 'horario': '02/06/22', 'mensagem': 'www.link.com' }]
    },
    {
        'nome-input': 'Faculdade', 'comment-input': 'Datas importantes', 'corSelecionada': 'red', 'cor': converteCor('red'), 'mensagens':
            [{ 'foto': 'img3.jpg', 'nome': 'Léo', 'horario': '16:40', 'mensagem': 'Prova dia 05/07 às 10:30' },
            { 'foto': 'img7.jpg', 'nome': 'Valéria Silva', 'horario': '11/06/22', 'mensagem': 'O trabalho de AEDs foi adiado pro dia 19/06' },
            { 'foto': 'img2.jpg', 'nome': 'Cauã', 'horario': '06/06/22', 'mensagem': 'A matéria da prova de cálculo tá no Canvas' }]
    },
    {
        'nome-input': 'Datas importantes', 'comment-input': 'Nivers e eventos', 'corSelecionada': 'amarelo', 'cor': converteCor('amarelo'), 'mensagens':
            [{ 'foto': 'img5.jpg', 'nome': 'Tio Túlio', 'horario': '13:57', 'mensagem': 'Festa João dia 10/08 às 19:00' },
            { 'foto': 'img7.jpg', 'nome': 'Valéria Silva', 'horario': '10:32', 'mensagem': 'O niver do Pedrinho é Segunda agora' }]
    }];
var pastaAtual = 0;
    ...
    for (let i = 0; i < pastas.length; i++) {
        ...
        document.getElementById('pastas').innerHTML += `
            <div onclick="atualizaRightSide(${i})" class="block" id="pasta-item${i}">
                <div class="imgbox">
                <ion-icon name="folder-outline" class="${corPasta}" style="background-color:${converteCor(pastas[i]['corSelecionada'])}";></ion-icon>
                </div>
                <div class="details">
                    <div class="listHead">
...
document.getElementById('trash').addEventListener('click', (evento) => {
    let confirma = confirm(`Deseja deletar esta pasta?`);
    if (confirma == true) {
